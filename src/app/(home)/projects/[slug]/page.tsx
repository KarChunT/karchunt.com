        ...
        <div className="flex flex-col gap-4 border-l p-4 text-sm lg:w-[250px]">
          ...
          <div>
            ...
            <p className="font-medium">
              {new Date(page.data.lastUpdated ?? page.file.name).toDateString()}
            </p>
          </div>

          <div>
            <p className="text-fd-muted-foreground mb-1">Languages</p>
            <div className="flex flex-wrap gap-2">
              {page.data.languages.map((tag) => (
          ...
          <div>
            <p className="text-fd-muted-foreground mb-1">Links</p>
