...
```yaml filename="docker-config.yaml"
apiVersion: v1
kind: Secret
metadata:
...
```yaml filename="basic-authentication.yaml"
apiVersion: v1
kind: Secret
metadata:
...
```yaml filename="ssh-authentication.yaml"
apiVersion: v1
kind: Secret
metadata:
