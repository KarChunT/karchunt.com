...
const QUIZ_BASE_LINK = '/quiz';

const QuizClient = ({ quizzes }: { quizzes: QuizItem[] }) => {
  const [searchTerm, setSearchTerm] = useState('');
  const filteredQuiz = Object.entries(quizzes).filter(([key, item]) =>
