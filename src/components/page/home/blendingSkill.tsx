...
import BeamOfMe from '@/components/page/home/beamOfMe';

const BlendingSkill = () => {
  const images = SKILLS_SLUGS.map(
    ...
    <div className="mx-auto max-w-[64rem] px-4 pt-20">
      ...
      <BlurFade delay={0.25 * 3} inView>
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
          {/* IconCloud */}
          <div className="bg-background relative mx-auto flex size-full max-w-lg items-center justify-center overflow-hidden rounded-lg border border-neutral-700 px-20 pt-8 pb-20">
