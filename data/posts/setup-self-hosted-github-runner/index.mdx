...
description: "Learn how to setup self-hosted GitHub runner by yourself."
...
2. In Settings > Actions > Runners, click on **New self-hosted runner** button.
   ![img1](/assets/posts/setup-self-hosted-github-runner/img1.png)

3. Choose Windows Runner Image and Architecture. Do take note that, the architecture is based on your device specifications. For my case is **x64**.
   ![img2](/assets/posts/setup-self-hosted-github-runner/img2.png)

4. Download the necessary files. You can find all these commands on the same page where you select Windows Runner Image and Architecture.
   ...
   ![img3](/assets/posts/setup-self-hosted-github-runner/img3.png)
...
5. Configure and start the runner.
   ...
   ![img4](/assets/posts/setup-self-hosted-github-runner/img4.png)
   ![img5](/assets/posts/setup-self-hosted-github-runner/img5.png)

6. Using your self-hosted runner. Create a new file under `.github/workflows/test.yaml`.

   ```yaml {7} title="test.yaml"
   name: Test runner
   on:
      push:
   jobs:
   ...
   ![img6](/assets/posts/setup-self-hosted-github-runner/img6.png)
